...
![1624366302686](typora-user-images/1624366302686.png)
...
关于类初始化代码，是先执行父类的，再执行子类的，不过，父类执行时，子类静态变量的值也是有的，是默认值。对于默认值，我们之前说过，数字型变量都是0，boolean是false，char是'\u0000'，引用型变量是null。
