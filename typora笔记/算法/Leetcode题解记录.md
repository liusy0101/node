...
func findMedianSortedArrays(nums1 []int, nums2 []int) float64 {
	...
	if (m + n) % 2 != 0 {
		mid = float64(result[midNum])
	} else {
		mid = float64(result[midNum] + result[midNum-1]) / 2
	}
	return mid
}
```
...
用一个临时变量存储遍历个数，每次遇到第k个进行反转

此时需要将当前节点的next置为null

还需要一个记录前驱指针的result



反转过后，将前驱指针指向新头节点，然后之前的头节点指向next
...
public static ListNode reverseKGroup (ListNode head, int k) {
        ...
        while (head != null) {
            ...
            if (tem == k ) {
                ...
                ListNode temHead = reverse(currHead);
                result.next = temHead;
                result = currHead;
                currHead.next = nn;
...
![image-20211219235136482](../typora-user-images/image-20211219235136482.png)
...
![image-20211026232017624](../typora-user-images/image-20211026232017624.png)
  ...
  [4. 找零钱的最少硬币数](https://leetcode-cn.com/problems/coin-change/)
...
![image-20211031225852142](../typora-user-images/image-20211031225852142.png)
...
![image-20211031230532613](../typora-user-images/image-20211031230532613.png)
